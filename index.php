<?php get_header(); ?>
    ...
    <div class="mainvisual">
        <div class="fadein"> 
            ...
            <img class="visual_1" id="targetImage" src="<?php echo get_template_directory_uri(); ?>/img/visual_7_pc.png">
            <img class="visual_1" id="targetImage" src="<?php echo get_template_directory_uri(); ?>/img\visual_6_pc.png">
        </div>
